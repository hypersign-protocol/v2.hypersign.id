import{e as p,J as g,n as f,p as n,u as c,v as d,s as h,q as t,F as m,z as y,C as a,L as v,I as b,x as r}from"./vue-C-T7Yazi.js";import{u as w}from"./app-BomcSR0c.js";import{_ as k}from"./plugin-vue_export-helper-DlAUqK2U.js";import"./icons-Gp_skxLz.js";const C={key:0,style:{"max-width":"780px",margin:"0 auto",padding:"56px 24px 100px"}},A={style:{"margin-bottom":"40px"}},T={style:{display:"flex","align-items":"center",gap:"10px","margin-bottom":"18px","flex-wrap":"wrap"}},D={style:{"font-size":"clamp(26px, 4vw, 42px)","font-weight":"lighter","line-height":"1.15",color:"hsl(var(--foreground))","margin-bottom":"18px"}},I={style:{"font-size":"18px",color:"var(--text-body)","line-height":"1.6","margin-bottom":"24px","max-width":"680px"}},x={style:{display:"flex","align-items":"center",gap:"8px","font-size":"13px",color:"var(--text-muted)"}},K={style:{"font-weight":"600"}},Y=["innerHTML"],P={key:1,style:{"text-align":"center",padding:"100px 24px"}},W=p({__name:"BlogDetailPage",setup(q){const o=g(),u={"kyc-is-becoming-infrastructure":{slug:"kyc-is-becoming-infrastructure",title:"KYC Isn't a Feature Anymore. It's Becoming Infrastructure",excerpt:"Fraud is rising across fintech and Web3, but repeating the same identity checks at every platform isn't solving it. Here's why compliance is shifting from one-time verification to reusable, privacy-first trust infrastructure.",author:"Hypersign Team",date:"July 7, 2026",readTime:"5 min",tags:["Identity","Compliance"],body:`
    ...
    `}},i=b(()=>u[o.params.slug]??null);return w(()=>i.value?{title:i.value.title,description:i.value.excerpt,canonicalPath:`/resources/blog/${i.value.slug}`,ogType:"article"}:{title:"Blog Post Not Found",description:"The requested Hypersign blog post could not be found.",robots:"noindex, follow"},()=>o.path),(S,e)=>{const s=f("RouterLink");return i.value?(r(),n("div",C,[c(s,{to:"/resources",style:{display:"inline-flex","align-items":"center",gap:"6px","font-size":"13px",color:"var(--text-muted)","text-decoration":"none","margin-bottom":"44px","font-weight":"600","letter-spacing":"0.01em"}},{default:d(()=>[...e[0]||(e[0]=[h(" ← Back to Resources ",-1)])]),_:1}),t("div",A,[t("div",T,[(r(!0),n(m,null,y(i.value.tags,l=>(r(),n("span",{key:l,style:{"font-size":"11px","font-weight":"700","letter-spacing":"1.5px","text-transform":"uppercase",border:"1px solid hsl(var(--border))","border-radius":"6px",padding:"4px 10px",color:"var(--text-muted)"}},a(l),1))),128))]),t("h1",D,a(i.value.title),1),t("p",I,a(i.value.excerpt),1),t("div",x,[t("span",K,a(i.value.author),1),e[1]||(e[1]=t("span",null,"·",-1)),t("span",null,a(i.value.date),1),e[2]||(e[2]=t("span",null,"·",-1)),t("span",null,a(i.value.readTime)+" read",1)])]),e[3]||(e[3]=t("div",{style:{height:"1px",background:"hsl(var(--border))","margin-bottom":"48px"}},null,-1)),t("div",{class:"blog-body",innerHTML:i.value.body},null,8,Y),e[4]||(e[4]=v('<div style="height:1px;background:hsl(var(--border));margin-top:64px;margin-bottom:56px;" data-v-6d37359f></div><div style="border:1px solid hsl(var(--border));border-radius:16px;padding:40px;text-align:center;background:hsl(var(--soft));" data-v-6d37359f><h3 style="font-size:24px;font-weight:lighter;color:hsl(var(--foreground));margin-bottom:10px;" data-v-6d37359f> Ready to add identity verification to your platform? </h3><p style="color:var(--text-body);margin-bottom:24px;font-size:15px;" data-v-6d37359f> See how Hypersign&#39;s on-chain KYC and reusable credential infrastructure works book a 30-minute demo. </p><a href="https://calendly.com/hypersign" target="_blank" rel="noopener noreferrer" style="display:inline-flex;align-items:center;gap:8px;background:#404462;color:#fff;font-weight:lighter;padding:13px 28px;border-radius:8px;font-size:15px;text-decoration:none;" data-v-6d37359f> Book a Demo → </a></div>',2))])):(r(),n("div",P,[e[6]||(e[6]=t("p",{style:{color:"var(--text-muted)","margin-bottom":"16px"}},"Blog post not found.",-1)),c(s,{to:"/resources",style:{color:"#404462","text-decoration":"none","font-weight":"600"}},{default:d(()=>[...e[5]||(e[5]=[h("← Back to Resources",-1)])]),_:1})]))}}}),L=k(W,[["__scopeId","data-v-6d37359f"]]);export{L as default};
