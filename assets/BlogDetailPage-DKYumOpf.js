import{e as y,J as b,n as v,p as o,u as h,v as p,s as u,q as a,F as w,z as k,C as n,L as C,I as g,x as s}from"./vue-C-T7Yazi.js";import{u as A}from"./app-Boblim_v.js";import{_ as D}from"./plugin-vue_export-helper-DlAUqK2U.js";import"./icons-ugt4tdvP.js";const P={key:0,style:{"max-width":"780px",margin:"0 auto",padding:"56px 24px 100px"}},I={style:{"margin-bottom":"40px"}},T={style:{display:"flex","align-items":"center",gap:"10px","margin-bottom":"18px","flex-wrap":"wrap"}},x={style:{"font-size":"clamp(26px, 4vw, 42px)","font-weight":"lighter","line-height":"1.15",color:"hsl(var(--foreground))","margin-bottom":"18px"}},Y={style:{"font-size":"18px",color:"var(--text-body)","line-height":"1.6","margin-bottom":"24px","max-width":"680px"}},K={style:{display:"flex","align-items":"center",gap:"8px","font-size":"13px",color:"var(--text-muted)"}},S={style:{"font-weight":"600"}},W=["innerHTML"],M={key:1,style:{"text-align":"center",padding:"100px 24px"}},R=y({__name:"BlogDetailPage",setup(q){const l=b(),m={"dpdp-consent-manager-vs-consent-platform-fintech":{slug:"dpdp-consent-manager-vs-consent-platform-fintech",title:"DPDP Consent Manager vs. Consent Management Platform vs. KYC-Embedded Consent: What Your Fintech Actually Needs",excerpt:`"Consent Manager" is a specific, registered role under the DPDP Act. A "consent management platform" is a software category most vendors selling into fintech actually belong to. Neither is the same as consent captured at the KYC moment. Here's the boundary between all three, and which one (or two) a fintech actually needs.`,author:"Hypersign Team",date:"July 20, 2026",readTime:"8 min",tags:["Compliance","Fintech"],body:`
      <p>Search for a DPDP consent solution and three genuinely different things come back under the same word. A <strong>Consent Manager</strong> is a specific, registered role the DPDP Act itself defines, one almost no fintech should try to become. A <strong>Consent Management Platform (CMP)</strong> is a software category, cookie banners, marketing-consent orchestration, and data-sharing preference centers, that a growing list of India-focused vendors sell into every regulated business. And <strong>KYC-embedded consent</strong> is what happens (or doesn't) at the exact moment a PAN, Aadhaar, or biometric check runs during onboarding, before a CMP ever gets involved. Most of the confusion in vendor pitches comes from treating these as competitors when they're actually three different layers, and most fintechs end up needing two of the three, not one.</p>

      <h2>Three Things, Not One</h2>
      <p>Here's the boundary, mapped against what each one is actually built to do and who occupies it today.</p>

      <div class="bg-map-table">
        <div class="bg-map-row">
          <div class="bg-map-tags"><span class="bg-map-tag bg-map-tag-fiduciary">Registered Role · DPDP Act</span></div>
          <div class="bg-map-obligation">Consent Manager</div>
          <div class="bg-map-solution">A separately licensed intermediary that gives a Data Principal one dashboard to give, manage, and withdraw consent for personal data moving between Data Fiduciaries, an Account-Aggregator-style role for personal data generally, not just financial data. Registration requires incorporation as an Indian company, a minimum net worth threshold, and Data Protection Board approval under the First Schedule. Nobody is live in this role yet; registration opens on the date the DPDP Rules set for it, and building toward it is a multi-quarter regulatory undertaking, not a product decision.</div>
          <a class="bg-map-cite" href="https://indiankanoon.org/doc/15072321/" target="_blank" rel="noopener noreferrer">DPDP Act 2023, Section 6(7)&ndash;(9) (Consent Manager) →</a>
        </div>
        <div class="bg-map-row">
          <div class="bg-map-tags"><span class="bg-map-tag bg-map-tag-processor">Software Category</span></div>
          <div class="bg-map-obligation">Consent Management Platform (CMP)</div>
          <div class="bg-map-solution">A software layer a Data Fiduciary runs across its own business, cookie banners, marketing and newsletter opt-ins, data-sharing preferences with partners and ad tech, mapped to notice text and logged for audit. This is the category most India-focused DPDP vendors, OneTrust's DPDPA module, Consently, ConsentOS, Digital Anumati, and similar tools actually compete in. It sits above and across every product a business runs, not inside any one of them.</div>
          <a class="bg-map-cite" href="https://www.meity.gov.in/documents/act-and-policies/digital-personal-data-protection-rules-2025-gDOxUjMtQWa" target="_blank" rel="noopener noreferrer">DPDP Rules 2025, Rule 4 &amp; First Schedule →</a>
        </div>
        <div class="bg-map-row">
          <div class="bg-map-tags"><span class="bg-map-tag bg-map-tag-fiduciary">Where Hypersign Sits</span></div>
          <div class="bg-map-obligation">KYC-Embedded Consent Infrastructure</div>
          <div class="bg-map-solution">Purpose-based, revocable consent captured at the specific moment a PAN, Aadhaar, or biometric check runs, before that data is ever collected, not layered on afterward as a policy screen. This is narrower than a CMP by design: it doesn't manage cookie preferences or marketing opt-ins across a business, it makes consent a structural property of the identity-verification step itself, timestamped, signed, and audit-ready for that specific event.</div>
          <a class="bg-map-cite" href="https://indiankanoon.org/doc/15072321/" target="_blank" rel="noopener noreferrer">DPDP Act 2023, Section 6(1), consent "limited to such personal data as is necessary" →</a>
        </div>
      </div>

      <h2>Which One Do You Actually Need?</h2>
      <p>Almost never just one. The honest decision tree looks like this:</p>
      <ul>
        <li><strong>Building or planning to register as a Consent Manager?</strong> That's not a build-vs-buy question, it's a licensing decision with a net-worth threshold and Data Protection Board approval attached. Almost no fintech should be evaluating this seriously unless data intermediation, not lending or payments, is the actual business.</li>
        <li><strong>Need consent, notice, and preference management across your whole product, cookies, marketing emails, data shared with partners and processors?</strong> That's a CMP. Evaluate Consently, ConsentOS, Digital Anumati, or OneTrust's DPDPA module on that basis, whole-of-business consent orchestration, not KYC specifically.</li>
        <li><strong>Need purpose-based, revocable, audit-ready consent at the specific moment you run PAN, Aadhaar, or biometric KYC?</strong> That's KYC-embedded consent, structural to the verification API itself rather than a layer bolted on top of it.</li>
      </ul>
      <p>Most regulated fintechs need the second and third together: a CMP for the whole-business surface (your marketing site, your app's notification preferences, your vendor data-sharing agreements) and KYC-embedded consent for the specific, high-stakes moment identity documents and biometrics get collected. Treating a CMP as sufficient for the KYC moment is the most common gap, general-purpose consent platforms log a checkbox; they don't typically capture per-purpose consent tied to a specific PAN or Aadhaar verification call, timestamped against that exact API request.</p>

      <div class="bg-compare-grid">
        <div class="bg-compare-card bg-compare-scope-a">
          <div class="bg-compare-tag">What a General-Purpose CMP Handles</div>
          <div class="bg-compare-title">Whole-of-Business Consent</div>
          <ul class="bg-compare-list">
            <li>Cookie and tracking-technology consent across a website</li>
            <li>Marketing, newsletter, and notification opt-ins</li>
            <li>Data-sharing preferences with partners, processors, and ad networks</li>
            <li>Centralized DPIA and data-mapping workflows</li>
          </ul>
        </div>
        <div class="bg-compare-card bg-compare-scope-b">
          <div class="bg-compare-tag">What KYC-Embedded Consent Handles</div>
          <div class="bg-compare-title">The Identity-Verification Moment</div>
          <ul class="bg-compare-list">
            <li>Per-purpose consent (verification, AML screening, retention) before a PAN/Aadhaar/biometric check runs</li>
            <li>A signed, timestamped record tied to that specific verification event</li>
            <li>Automatic downstream enforcement when a purpose is withdrawn</li>
            <li>Retention and erasure scoped to identity-document categories specifically</li>
          </ul>
        </div>
      </div>

      <h2>A Related, Separate Problem: RBI Retention vs. DPDP Erasure</h2>
      <p>Whichever layer you're evaluating, it doesn't resolve a different structural conflict: RBI's KYC Master Directions require records retained for five years post-relationship, PMLA requires ten years for transaction records, and DPDP grants a right to erasure. None of the three categories above make that conflict disappear, a Consent Manager doesn't touch it, a CMP logs the erasure request but doesn't decide whether it can be honored, and KYC-embedded infrastructure can only enforce whatever retention rule it's configured with. The resolution in practice is a documented legal-basis exception: honor erasure for everything outside statutory retention scope, keep what RBI or PMLA compels with the basis on record, and don't treat "erasure requested" and "erasure required" as the same event. We've mapped this in more depth, including where it actually breaks a KYC stack, in <a href="/resources/blog/dpdp-act-kyc-compliance-fintech">DPDP Act Compliance for Fintech KYC</a>.</p>

      <h2>Where This Leaves an NBFC or Digital Lender Evaluating Vendors</h2>
      <p>None of this is a claim that Consently, ConsentOS, Digital Anumati, or OneTrust do a bad job, they're built for a real and different problem: consent orchestration across an entire business, not the KYC moment specifically. Hypersign doesn't compete for that whole-of-business layer and isn't pursuing Consent Manager registration either, both are described honestly in <a href="/resources/blog/account-aggregator-license-dpdp-kyc-consent-gap">Your Account Aggregator License Meets DPDP for Financial Data Consent</a>. What Hypersign is built for is the specific gap most CMPs don't reach: purpose-based, revocable, audit-ready consent structurally built into the PAN, Aadhaar, and biometric checks running at onboarding, see how that maps against DPDP's specific obligations on <a href="/platform/consent-management">the Consent Management Infrastructure page</a>.</p>

      <h2>FAQ</h2>

      <h3 style="font-size: 19px; font-weight: 600; margin: 28px 0 10px;">Is a DPDP Consent Manager the same as a consent management platform (CMP)?</h3>
      <p>No. A Consent Manager is a specific, separately registered role under DPDP Act Section 6(7)&ndash;(9), with a net-worth threshold and Data Protection Board approval required. A CMP is a software category, tools like OneTrust, Consently, or ConsentOS that businesses run themselves to manage cookie, marketing, and data-sharing consent. The terms get used interchangeably in marketing copy, but they're legally and functionally different things.</p>

      <h3 style="font-size: 19px; font-weight: 600; margin: 28px 0 10px;">Do I need a CMP if I already have consent capture in my KYC flow?</h3>
      <p>Usually yes, for different reasons. KYC-embedded consent covers the specific PAN, Aadhaar, or biometric verification moment. It typically doesn't cover cookie consent on your marketing site, newsletter opt-ins, or data-sharing terms with a payments partner, that's what a whole-of-business CMP is built for. Most regulated fintechs need both, not one instead of the other.</p>

      <h3 style="font-size: 19px; font-weight: 600; margin: 28px 0 10px;">Is Hypersign a Consent Manager or a CMP?</h3>
      <p>Neither. Hypersign is identity verification infrastructure with purpose-based, revocable, audit-ready consent built into the KYC moment itself, not a registered Consent Manager and not a general-purpose consent platform for cookies, marketing, or business-wide data-sharing preferences.</p>

      <h3 style="font-size: 19px; font-weight: 600; margin: 28px 0 10px;">When does the DPDP Consent Manager framework actually become usable?</h3>
      <p>The DPDP Rules 2025 set out the registration mechanism (Rule 4, First Schedule) but no entity is live in the role yet as of this post. Confirm the current registration and commencement status directly against MeitY's notifications before assuming any vendor claiming the role is actually operating in it.</p>

      <h3 style="font-size: 19px; font-weight: 600; margin: 28px 0 10px;">Should a fintech build its own Consent Manager instead of buying a CMP?</h3>
      <p>Almost never. Becoming a registered Consent Manager is a licensing decision with an incorporation, net-worth, and Data Protection Board approval bar, similar in spirit to becoming an RBI-licensed NBFC-AA. It only makes sense if data intermediation itself is the business, not an add-on to lending, payments, or another core product.</p>

      <h2>References</h2>
      <p>Primary sources for the citations above:</p>
      <ul class="bg-ref-list">
        <li><a href="https://indiankanoon.org/doc/15072321/" target="_blank" rel="noopener noreferrer">DPDP Act 2023, Section 6 &mdash; Consent, incl. 6(7)&ndash;(9) on Consent Managers (Indian Kanoon)</a></li>
        <li><a href="https://www.meity.gov.in/documents/act-and-policies/digital-personal-data-protection-rules-2025-gDOxUjMtQWa" target="_blank" rel="noopener noreferrer">Digital Personal Data Protection Rules, 2025 (Gazette notification, MeitY)</a><br /><span class="bg-ref-source">Rule 4 and the First Schedule govern Consent Manager registration and eligibility.</span></li>
        <li><a href="https://www.meity.gov.in/static/uploads/2024/06/2bf1f0e9f04e6fb4f8fef35e82c42aa5.pdf" target="_blank" rel="noopener noreferrer">Digital Personal Data Protection Act, 2023 (full text, Ministry of Electronics and IT)</a></li>
      </ul>
      <p style="font-size: 13px; color: var(--text-muted);">Regulations change, and third-party vendor capabilities described here reflect public materials as of this post's publication date, not legal advice or a vendor endorsement. Confirm current registration status, product scope, and pricing directly with each vendor and against primary DPDP sources before making a compliance or purchasing decision.</p>

      <h2>About Hypersign</h2>
      <p>Hypersign is an identity verification API for PAN, Aadhaar, biometric, and business KYC, built so that purpose-based consent is a structural property of the verification step itself, not a policy layer or a separate consent platform bolted on afterward. It doesn't replace a whole-of-business CMP and isn't pursuing DPDP Consent Manager registration, it closes the specific gap at the KYC moment that neither of those categories is built to reach. See how that maps against DPDP's specific obligations in <a href="/resources/blog/dpdp-act-kyc-compliance-fintech">DPDP Act Compliance for Fintech KYC</a>.</p>
    `,faqs:[{question:"Is a DPDP Consent Manager the same as a consent management platform (CMP)?",answer:"No. A Consent Manager is a specific, separately registered role under DPDP Act Section 6(7)-(9), with a net-worth threshold and Data Protection Board approval required. A CMP is a software category, tools like OneTrust, Consently, or ConsentOS that businesses run themselves to manage cookie, marketing, and data-sharing consent. The terms get used interchangeably in marketing copy, but they're legally and functionally different things."},{question:"Do I need a CMP if I already have consent capture in my KYC flow?",answer:"Usually yes, for different reasons. KYC-embedded consent covers the specific PAN, Aadhaar, or biometric verification moment. It typically doesn't cover cookie consent on your marketing site, newsletter opt-ins, or data-sharing terms with a payments partner, that's what a whole-of-business CMP is built for. Most regulated fintechs need both, not one instead of the other."},{question:"Is Hypersign a Consent Manager or a CMP?",answer:"Neither. Hypersign is identity verification infrastructure with purpose-based, revocable, audit-ready consent built into the KYC moment itself, not a registered Consent Manager and not a general-purpose consent platform for cookies, marketing, or business-wide data-sharing preferences."},{question:"When does the DPDP Consent Manager framework actually become usable?",answer:"The DPDP Rules 2025 set out the registration mechanism (Rule 4, First Schedule) but no entity is live in the role yet as of this post. Confirm the current registration and commencement status directly against MeitY's notifications before assuming any vendor claiming the role is actually operating in it."},{question:"Should a fintech build its own Consent Manager instead of buying a CMP?",answer:"Almost never. Becoming a registered Consent Manager is a licensing decision with an incorporation, net-worth, and Data Protection Board approval bar, similar in spirit to becoming an RBI-licensed NBFC-AA. It only makes sense if data intermediation itself is the business, not an add-on to lending, payments, or another core product."}]},"account-aggregator-license-dpdp-kyc-consent-gap":{slug:"account-aggregator-license-dpdp-kyc-consent-gap",title:"Your Account Aggregator License Meets DPDP for Financial Data Consent. It Was Never Built for KYC Consent.",excerpt:"RBI built the Account Aggregator framework to move financial data with consent and nothing else. It was never scoped to cover PAN, Aadhaar, or biometric KYC consent and that's exactly the part of onboarding still sitting with whichever KYC vendor an NBFC plugged in years ago. Here's the boundary, mapped point-to-point against DPDP.",author:"Hypersign Team",date:"July 14, 2026",readTime:"9 min",tags:["Compliance","NBFC"],body:`
      <p>An NBFC that already holds an Account Aggregator license, or routes borrower bank-statement, GST, and mutual-fund data through one of the RBI-licensed NBFC-AAs live today (Sahamati, the industry alliance that runs the ecosystem's central registry, counts well over a dozen operating under a full RBI license), has already cleared a harder compliance bar than most fintechs ever attempt: a minimum Net Owned Funds threshold, an IT-systems audit, and the <a href="https://www.rbi.org.in/Scripts/BS_ViewMasDirections.aspx?id=10598" target="_blank" rel="noopener noreferrer">Reserve Bank of India (Non-Banking Financial Company &ndash; Account Aggregator) Directions</a> on exactly how consent-based data sharing has to work end to end. That's real, hard-won infrastructure. It's also, specifically, <strong>financial-data</strong> infrastructure, and RBI built it that way on purpose.</p>
      ...
      <p class="bg-liability-caption">That paragraph 6 restriction is exactly what keeps the AA framework clean, and it's exactly why it was never going to absorb identity verification consent. That gap doesn't close on its own, and no announced extension of Aadhaar's own APIs closes it either, because UIDAI's mandate, set out in <a href="https://upload.indiacode.nic.in/showfile?actid=AC_CEN_37_85_00001_201618_1517807328460&amp;filename=av_eng.pdf&amp;type=regulation" target="_blank" rel="noopener noreferrer">the Aadhaar (Authentication and Offline Verification) Regulations, 2021</a>, is authenticating one document, not orchestrating consent across PAN, biometrics, and video KYC as one flow.</p>
      ...
      <div class="bg-map-table">
        <div class="bg-map-row">
          ...
          <a class="bg-map-cite" href="https://www.indiacode.nic.in/show-data?abv=CEN&amp;actid=AC_CEN_45_0_00003_2023-22_1763464807080&amp;orderno=5&amp;orgactid=AC_CEN_45_0_00003_2023-22_1763464807080&amp;sectionId=101271&amp;sectionno=5&amp;statehandle=123456789%2F1362" target="_blank" rel="noopener noreferrer">DPDP Act 2023, Section 5 (Notice) &amp; Section 6(1) (Consent) →</a>
        </div>
        <div class="bg-map-row">
        ...
        <div class="bg-map-row">
          ...
          <a class="bg-map-cite" href="https://www.indiacode.nic.in/show-data?abv=CEN&amp;statehandle=123456789/1362&amp;actid=AC_CEN_45_0_00003_2023-22_1763464807080&amp;sectionId=101274&amp;sectionno=8&amp;orderno=8&amp;orgactid=AC_CEN_45_0_00003_2023-22_1763464807080" target="_blank" rel="noopener noreferrer">DPDP Act 2023, Section 8(7)&ndash;(8) (erasure on withdrawal or purpose completion) →</a>
        </div>
        <div class="bg-map-row">
          ...
          <a class="bg-map-cite" href="https://indiankanoon.org/doc/80701001/" target="_blank" rel="noopener noreferrer">DPDP Act 2023, Section 6(4) (withdrawal) &amp; Sections 11&ndash;13 (access, correction, grievance) →</a>
        </div>
        <div class="bg-map-row">
          ...
          <a class="bg-map-cite" href="https://www.indiacode.nic.in/show-data?abv=CEN&amp;statehandle=123456789/1362&amp;actid=AC_CEN_45_0_00003_2023-22_1763464807080&amp;sectionId=101274&amp;sectionno=8&amp;orderno=8&amp;orgactid=AC_CEN_45_0_00003_2023-22_1763464807080" target="_blank" rel="noopener noreferrer">DPDP Act 2023, Section 8(1)&ndash;(2) (fiduciary responsible for processor, valid contract) →</a>
        </div>
        <div class="bg-map-row">
          ...
          <a class="bg-map-cite" href="https://uidai.gov.in/en/ecosystem/authentication-devices-documents/about-aadhaar-paperless-offline-e-kyc.html" target="_blank" rel="noopener noreferrer">Aadhaar (Authentication and Offline Verification) Regulations, 2021 &amp; UIDAI Offline e-KYC norms →</a>
        </div>
      </div>
      ...
      <h2>References</h2>
      <p>Primary sources for every citation above, for compliance and legal teams who want to verify this directly rather than take a vendor's word for it:</p>
      <ul class="bg-ref-list">
        <li><a href="https://www.meity.gov.in/static/uploads/2024/06/2bf1f0e9f04e6fb4f8fef35e82c42aa5.pdf" target="_blank" rel="noopener noreferrer">Digital Personal Data Protection Act, 2023 (full text, Ministry of Electronics and IT)</a><br /><span class="bg-ref-source">Sections 5, 6, 8, 11, 12, and 13 cited above are all within this Act.</span></li>
        <li><a href="https://www.indiacode.nic.in/show-data?abv=CEN&amp;actid=AC_CEN_45_0_00003_2023-22_1763464807080&amp;orderno=5&amp;orgactid=AC_CEN_45_0_00003_2023-22_1763464807080&amp;sectionId=101271&amp;sectionno=5&amp;statehandle=123456789%2F1362" target="_blank" rel="noopener noreferrer">DPDP Act, Section 5 &mdash; Notice (India Code)</a></li>
        <li><a href="https://indiankanoon.org/doc/15072321/" target="_blank" rel="noopener noreferrer">DPDP Act, Section 6 &mdash; Consent, incl. 6(7)&ndash;(9) on Consent Managers (Indian Kanoon)</a></li>
        <li><a href="https://www.indiacode.nic.in/show-data?abv=CEN&amp;statehandle=123456789/1362&amp;actid=AC_CEN_45_0_00003_2023-22_1763464807080&amp;sectionId=101274&amp;sectionno=8&amp;orderno=8&amp;orgactid=AC_CEN_45_0_00003_2023-22_1763464807080" target="_blank" rel="noopener noreferrer">DPDP Act, Section 8 &mdash; General obligations of Data Fiduciary (India Code)</a></li>
        <li><a href="https://indiankanoon.org/doc/80701001/" target="_blank" rel="noopener noreferrer">DPDP Act, Section 11 &mdash; Right to access information (Indian Kanoon)</a></li>
        <li><a href="https://indiankanoon.org/doc/72504975/" target="_blank" rel="noopener noreferrer">DPDP Act, Section 12 &mdash; Right to correction and erasure (Indian Kanoon)</a></li>
        <li><a href="https://www.meity.gov.in/documents/act-and-policies/digital-personal-data-protection-rules-2025-gDOxUjMtQWa" target="_blank" rel="noopener noreferrer">Digital Personal Data Protection Rules, 2025 (Gazette notification, MeitY)</a><br /><span class="bg-ref-source">Rule 4 and the First Schedule govern Consent Manager registration and eligibility.</span></li>
        <li><a href="https://www.rbi.org.in/Scripts/BS_ViewMasDirections.aspx?id=10598" target="_blank" rel="noopener noreferrer">RBI (Non-Banking Financial Company &ndash; Account Aggregator) Directions (official RBI master direction page)</a><br /><span class="bg-ref-source">Paragraph 6 restricts an NBFC-AA to the business of account aggregation; a separate provision sets the &#8377;2 crore Net Owned Funds threshold.</span></li>
        <li><a href="https://upload.indiacode.nic.in/showfile?actid=AC_CEN_37_85_00001_201618_1517807328460&amp;filename=av_eng.pdf&amp;type=regulation" target="_blank" rel="noopener noreferrer">The Aadhaar (Authentication and Offline Verification) Regulations, 2021 (India Code)</a></li>
        <li><a href="https://uidai.gov.in/en/ecosystem/authentication-devices-documents/about-aadhaar-paperless-offline-e-kyc.html" target="_blank" rel="noopener noreferrer">UIDAI &mdash; Aadhaar Paperless Offline e-KYC (official UIDAI page)</a></li>
      </ul>
      <p style="font-size: 13px; color: var(--text-muted);">Regulations change. This mapping reflects the DPDP Act 2023, the DPDP Rules 2025 (notified November 13, 2025, with staggered commencement dates by provision), and the RBI Account Aggregator Directions as of this post's publication date, not legal advice, confirm current text against the primary sources above before relying on it for a compliance filing.</p>
    ...
    `,faqs:[{question:"We already run bank-statement and GST pulls through an AA partner. Does Hypersign replace that?",answer:"No. Keep your AA integration exactly as it is, whether that's Setu, Perfios, Anumati, CAMS Finserv, or another licensed NBFC-AA. Hypersign sits at the separate onboarding step where PAN, Aadhaar, and biometric KYC happen, a step no AA license was ever scoped to cover."},{question:"Are you registering as a DPDP Consent Manager?",answer:"No. Hypersign is an ID verification API. The consent, minimization, and audit properties described here are built into how that API handles identity data, not a claim to the separately-licensed Consent Manager role DPDP defines."},{question:"What kind of NBFC is this actually a good fit for?",answer:"Digital-first lenders doing PAN, Aadhaar, and biometric KYC at onboarding today through a document-storing vendor, who want the compliance posture DPDP requires to be architectural rather than a policy document their legal team maintains separately from what engineering actually built."},{question:"When is this not the right fit yet?",answer:"If your NBFC relies heavily on RBI's regulatory-sandbox video-KYC workflows or deep CKYCR search-and-upload tooling that a decade-old India-specific vendor like Signzy has built out, that specific depth isn't something a newer platform replicates overnight either. The honest answer is to evaluate both on the specific workflow you run most, not on a single feature list."},{question:"Do we still need separate AML and sanctions screening?",answer:"Yes, PMLA obligations don't move. What changes is that the identity check feeding into that screening arrives as a verified, minimized claim rather than a raw document your AML pipeline then has to store as well."},{question:"Can this reduce repeat KYC across our own products or a lending consortium?",answer:"Within your own stack, yes, a borrower verified once can present a reusable credential for a second product line instead of re-uploading documents. Across an external consortium, that depends on the other parties accepting the same credential format, Hypersign doesn't claim to be the interoperability layer across every bank and NBFC in India, that's a much larger, separately-regulated proposition."},{question:"Does this cover business borrowers, not just individuals?",answer:"Yes, for MSME and business-loan onboarding, the same minimization principle applies through business verification (KYB), GSTIN and director-identity checks return verified claims rather than a folder of uploaded incorporation documents."}]},"kyc-is-becoming-infrastructure":{slug:"kyc-is-becoming-infrastructure",title:"KYC Isn't a Feature Anymore. It's Becoming Infrastructure",excerpt:"Fraud is rising across fintech and Web3, but repeating the same identity checks at every platform isn't solving it. Here's why compliance is shifting from one-time verification to reusable, privacy-first trust infrastructure.",author:"Hypersign Team",date:"July 7, 2026",readTime:"5 min",tags:["Identity","Compliance"],body:`
    ...
    `}},e=g(()=>m[l.params.slug]??null);function c(i){const t=new Date(i);return Number.isNaN(t.getTime())?i:t.toISOString().slice(0,10)}const f=g(()=>{if(!e.value)return null;const i=`https://hypersign.id/resources/blog/${e.value.slug}`,t=[{"@type":"BlogPosting",headline:e.value.title,description:e.value.excerpt,url:i,datePublished:c(e.value.date),dateModified:c(e.value.updated??e.value.date),author:{"@type":"Organization",name:e.value.author,url:"https://hypersign.id"},publisher:{"@id":"https://hypersign.id/#organization"},mainEntityOfPage:{"@type":"WebPage","@id":i}}];return e.value.faqs?.length&&t.push({"@type":"FAQPage",mainEntity:e.value.faqs.map(r=>({"@type":"Question",name:r.question,acceptedAnswer:{"@type":"Answer",text:r.answer}}))}),{"@context":"https://schema.org","@graph":t}});return A(()=>e.value?{title:e.value.title,description:e.value.excerpt,canonicalPath:`/resources/blog/${e.value.slug}`,ogType:"article",structuredData:f.value}:{title:"Blog Post Not Found",description:"The requested Hypersign blog post could not be found.",robots:"noindex, follow"},()=>l.path),(i,t)=>{const r=v("RouterLink");return e.value?(s(),o("div",P,[h(r,{to:"/resources",style:{display:"inline-flex","align-items":"center",gap:"6px","font-size":"13px",color:"var(--text-muted)","text-decoration":"none","margin-bottom":"44px","font-weight":"600","letter-spacing":"0.01em"}},{default:p(()=>[...t[0]||(t[0]=[u(" ← Back to Resources ",-1)])]),_:1}),a("div",I,[a("div",T,[(s(!0),o(w,null,k(e.value.tags,d=>(s(),o("span",{key:d,style:{"font-size":"11px","font-weight":"700","letter-spacing":"1.5px","text-transform":"uppercase",border:"1px solid hsl(var(--border))","border-radius":"6px",padding:"4px 10px",color:"var(--text-muted)"}},n(d),1))),128))]),a("h1",x,n(e.value.title),1),a("p",Y,n(e.value.excerpt),1),a("div",K,[a("span",S,n(e.value.author),1),t[1]||(t[1]=a("span",null,"·",-1)),a("span",null,n(e.value.date),1),t[2]||(t[2]=a("span",null,"·",-1)),a("span",null,n(e.value.readTime)+" read",1)])]),t[3]||(t[3]=a("div",{style:{height:"1px",background:"hsl(var(--border))","margin-bottom":"48px"}},null,-1)),a("div",{class:"blog-body",innerHTML:e.value.body},null,8,W),t[4]||(t[4]=C('<div style="height:1px;background:hsl(var(--border));margin-top:64px;margin-bottom:56px;" data-v-ee39adae></div><div style="border:1px solid hsl(var(--border));border-radius:16px;padding:40px;text-align:center;background:hsl(var(--soft));" data-v-ee39adae><h3 style="font-size:24px;font-weight:lighter;color:hsl(var(--foreground));margin-bottom:10px;" data-v-ee39adae> Ready to add identity verification to your platform? </h3><p style="color:var(--text-body);margin-bottom:24px;font-size:15px;" data-v-ee39adae> See how Hypersign&#39;s enterprise identity verification and reusable credential infrastructure works book a 30-minute demo. </p><a href="https://calendly.com/hypersign" target="_blank" rel="noopener noreferrer" style="display:inline-flex;align-items:center;gap:8px;background:#404462;color:#fff;font-weight:lighter;padding:13px 28px;border-radius:8px;font-size:15px;text-decoration:none;" data-v-ee39adae> Book a Demo → </a></div>',2))])):(s(),o("div",M,[t[6]||(t[6]=a("p",{style:{color:"var(--text-muted)","margin-bottom":"16px"}},"Blog post not found.",-1)),h(r,{to:"/resources",style:{color:"#404462","text-decoration":"none","font-weight":"600"}},{default:p(()=>[...t[5]||(t[5]=[u("← Back to Resources",-1)])]),_:1})]))}}}),E=D(R,[["__scopeId","data-v-ee39adae"]]);export{E as default};
