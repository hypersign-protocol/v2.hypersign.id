import{e as u,J as g,n as f,p as n,u as c,v as d,s as h,q as t,F as m,z as y,C as i,L as v,I as b,x as r}from"./vue-C-T7Yazi.js";import{u as w}from"./app-ClZ8UchT.js";import{_ as k}from"./plugin-vue_export-helper-DlAUqK2U.js";import"./icons-ugt4tdvP.js";const C={key:0,style:{"max-width":"780px",margin:"0 auto",padding:"56px 24px 100px"}},A={style:{"margin-bottom":"40px"}},D={style:{display:"flex","align-items":"center",gap:"10px","margin-bottom":"18px","flex-wrap":"wrap"}},I={style:{"font-size":"clamp(26px, 4vw, 42px)","font-weight":"lighter","line-height":"1.15",color:"hsl(var(--foreground))","margin-bottom":"18px"}},T={style:{"font-size":"18px",color:"var(--text-body)","line-height":"1.6","margin-bottom":"24px","max-width":"680px"}},x={style:{display:"flex","align-items":"center",gap:"8px","font-size":"13px",color:"var(--text-muted)"}},P={style:{"font-weight":"600"}},K=["innerHTML"],Y={key:1,style:{"text-align":"center",padding:"100px 24px"}},S=u({__name:"BlogDetailPage",setup(W){const o=g(),p={"account-aggregator-license-dpdp-kyc-consent-gap":{slug:"account-aggregator-license-dpdp-kyc-consent-gap",title:"Your Account Aggregator License Meets DPDP for Financial Data Consent. It Was Never Built for KYC Consent.",excerpt:"RBI built the Account Aggregator framework to move financial data with consent and nothing else. It was never scoped to cover PAN, Aadhaar, or biometric KYC consent and that's exactly the part of onboarding still sitting with whichever KYC vendor an NBFC plugged in years ago. Here's the boundary, mapped point-to-point against DPDP.",author:"Hypersign Team",date:"July 14, 2026",readTime:"9 min",tags:["Compliance","NBFC"],body:`
    ...
    `}},a=b(()=>p[o.params.slug]??null);return w(()=>a.value?{title:a.value.title,description:a.value.excerpt,canonicalPath:`/resources/blog/${a.value.slug}`,ogType:"article"}:{title:"Blog Post Not Found",description:"The requested Hypersign blog post could not be found.",robots:"noindex, follow"},()=>o.path),(R,e)=>{const s=f("RouterLink");return a.value?(r(),n("div",C,[c(s,{to:"/resources",style:{display:"inline-flex","align-items":"center",gap:"6px","font-size":"13px",color:"var(--text-muted)","text-decoration":"none","margin-bottom":"44px","font-weight":"600","letter-spacing":"0.01em"}},{default:d(()=>[...e[0]||(e[0]=[h(" ← Back to Resources ",-1)])]),_:1}),t("div",A,[t("div",D,[(r(!0),n(m,null,y(a.value.tags,l=>(r(),n("span",{key:l,style:{"font-size":"11px","font-weight":"700","letter-spacing":"1.5px","text-transform":"uppercase",border:"1px solid hsl(var(--border))","border-radius":"6px",padding:"4px 10px",color:"var(--text-muted)"}},i(l),1))),128))]),t("h1",I,i(a.value.title),1),t("p",T,i(a.value.excerpt),1),t("div",x,[t("span",P,i(a.value.author),1),e[1]||(e[1]=t("span",null,"·",-1)),t("span",null,i(a.value.date),1),e[2]||(e[2]=t("span",null,"·",-1)),t("span",null,i(a.value.readTime)+" read",1)])]),e[3]||(e[3]=t("div",{style:{height:"1px",background:"hsl(var(--border))","margin-bottom":"48px"}},null,-1)),t("div",{class:"blog-body",innerHTML:a.value.body},null,8,K),e[4]||(e[4]=v('<div style="height:1px;background:hsl(var(--border));margin-top:64px;margin-bottom:56px;" data-v-df251960></div><div style="border:1px solid hsl(var(--border));border-radius:16px;padding:40px;text-align:center;background:hsl(var(--soft));" data-v-df251960><h3 style="font-size:24px;font-weight:lighter;color:hsl(var(--foreground));margin-bottom:10px;" data-v-df251960> Ready to add identity verification to your platform? </h3><p style="color:var(--text-body);margin-bottom:24px;font-size:15px;" data-v-df251960> See how Hypersign&#39;s enterprise identity verification and reusable credential infrastructure works book a 30-minute demo. </p><a href="https://calendly.com/hypersign" target="_blank" rel="noopener noreferrer" style="display:inline-flex;align-items:center;gap:8px;background:#404462;color:#fff;font-weight:lighter;padding:13px 28px;border-radius:8px;font-size:15px;text-decoration:none;" data-v-df251960> Book a Demo → </a></div>',2))])):(r(),n("div",Y,[e[6]||(e[6]=t("p",{style:{color:"var(--text-muted)","margin-bottom":"16px"}},"Blog post not found.",-1)),c(s,{to:"/resources",style:{color:"#404462","text-decoration":"none","font-weight":"600"}},{default:d(()=>[...e[5]||(e[5]=[h("← Back to Resources",-1)])]),_:1})]))}}}),M=k(S,[["__scopeId","data-v-df251960"]]);export{M as default};
